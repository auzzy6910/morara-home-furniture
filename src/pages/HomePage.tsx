...
export default function HomePage() {
  ...
  const promoImages = [
    'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop&fm=webp', // Luxe Velvet Sofa
    'https://images.unsplash.com/photo-1532372576444-dda954194ad0?w=800&h=600&fit=crop&fm=webp', // Modern Coffee Table
    'https://images.unsplash.com/photo-1594620302200-9a762244a156?w=800&h=600&fit=crop&fm=webp', // Bookshelf Cabinet
    'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop&fm=webp', // Accent Armchair
    'https://images.unsplash.com/photo-1617806118233-18e1de247200?w=800&h=600&fit=crop&fm=webp', // Dining Table
  ];
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: 'Living Room', image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop&fm=webp', count: 4 },
              { name: 'Bedroom', image: 'https://images.unsplash.com/photo-1505693314120-0d443867891c?w=400&h=300&fit=crop&fm=webp', count: 3 },
              { name: 'Dining Room', image: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?w=400&h=300&fit=crop&fm=webp', count: 1 },
              { name: 'Office', image: 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=400&h=300&fit=crop&fm=webp', count: 2 },
            ].map(cat => (
              <Link
                key={cat.name}
                to="/shop"
